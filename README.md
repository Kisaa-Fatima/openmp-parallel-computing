...
This repository includes three distinct parallel computing projects implemented using C/C++ and OpenMP. Each project focuses on parallel performance, synchronization, and scalable execution.
